    ...
    >
      ...
      <div className="relative z-20 max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-4 items-center">
        ...
        <div className="text-center lg:text-left lg:pr-8">
          ...
          {/* Main heading */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 font-[VT323]">
            <span className="text-[var(--accent-green)]">
              <TypingEffect text={`Hi, I'm ${personalInfo.name}`} speed={70} />
            </span>
          </h1>
          ...
          {showButtons && (
            ...
            >
              <motion.a
                href="#projects"
                className="group relative px-8 py-3 bg-transparent border border-[var(--accent-green)] text-[var(--accent-green)] rounded-md font-mono text-sm overflow-hidden transition-all duration-300 hover:bg-[var(--accent-green)] hover:text-[var(--bg-base)] text-center"
              ...
              <motion.a
                href="#contact"
                className="group relative px-8 py-3 bg-[var(--accent-green)] text-[var(--bg-base)] rounded-md font-mono text-sm font-semibold overflow-hidden transition-all duration-300 hover:bg-[var(--accent-cyan)] text-center"
                whileHover={{ scale: 1.05, boxShadow: "0 0 25px rgba(0,255,65,0.4)" }}
                whileTap={{ scale: 0.95 }}
                onClick={(e) => {
                  e.preventDefault();
